...
List<SymptomsModel> symptomsData = [
  ...
  SymptomsModel(
    ...
    imageURL: AssetImages.difficultyBreathing,
  ),
  SymptomsModel(
    title: 'Headache',
    description:
