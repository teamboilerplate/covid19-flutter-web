...
/// **Requires**
/// 1. [onRetry] - Retry function for the Erroor Button
/// 2. [image] - Error Image to be displayed ([ImageProvided] has to be passed)
/// 3. [title, actionText, desc] - title and description of the error and actionText represents the retry button label
/// 4. [imageWidthFrac, imageHeightFrac] - imageWidthFrac * DeviceWidth and imageHeightFrac * DeviceHeight for the Image
