...
import 'package:covid19/ui/mythBusters/widgets/myth_fact_item_widget_desktop.dart';
...
class MythCardDesktopWidget extends StatelessWidget {
  final String myth, fact;

  const MythCardDesktopWidget({
    Key key,
    @required this.myth,
    @required this.fact,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: MythFactItemDesktopWidget(
        screenWidth: screenWidth,
        screenHeight: screenHeight,
